...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.lion.rc
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service.lion.xml
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.wifi@1.0-service-lazy.lion
...
LOCAL_REQUIRED_MODULES := \
    android.hardware.wifi@1.0-service-lazy.lion.rc \
    android.hardware.wifi@1.0-service.lion.xml
